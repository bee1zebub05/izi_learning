...
abstract class ApiModule {
  @Named('apiUrl')
  String get apiUrl => AppEnvironment.apiUrl;
  
  @singleton
  @Named('dio')
  Dio dio(@Named('apiUrl') String url, Talker talker) => Dio(
      BaseOptions(
        baseUrl: url,
        headers: {
...
extension DioExceptionX on DioException {
  ApiError toApiError() {
    if (type == DioExceptionType.cancel) {
      ...
      responseMessage = responseMessage ?? "Error unexpected";
      if (statusCode == 401) {
